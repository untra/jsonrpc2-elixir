defmodule JSONRPC2.VSCodeTest do
  ...
  setup do
    ...
    {:ok, pid} = JSONRPC2.Servers.TCP.start_listener(JSONRPC2.VSCodeHandler, port, name: __MODULE__)
  ...
  defp serialize_deserialize_test(value) do
    {:ok, encoded} = VSCode.encode(value)
    {:ok, decoded} = VSCode.decode(encoded)
